...
def main():
    parser = argparse.ArgumentParser(description='Offline reverse engineering tools for automotive networks.')
    ...
    uds_parser.add_argument('tx_id', type=auto_int,
                             help="CAN arbitration ID transmitted by the scan tool")
    uds_parser.add_argument('rx_id', type=auto_int,
                             help="CAN arbitration ID received by the scan tool")
